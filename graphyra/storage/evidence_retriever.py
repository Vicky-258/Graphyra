from graphyra.models.traversal_models import TraversalResult
...
class EvidenceRetriever:
    ...
    def retrieve_evidence(self, traversal_result: TraversalResult) -> list:
        ...
        chunk_to_entities = {}
        chunks_in_visited = [nid for nid in traversal_result.visited_nodes if nid.startswith("CHK_")]
        
        if chunks_in_visited:
            for cid in chunks_in_visited:
